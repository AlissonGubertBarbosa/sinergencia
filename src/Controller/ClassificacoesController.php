...
class ClassificacoesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Feedback', 'Usuariocomums'],
        ];
    ...
    public function add()
    {
        ...
        $feedback = $this->Classificacoes->Feedback->find('list', ['limit' => 200])->all();
        $usuariocomums = $this->Classificacoes->Usuariocomums->find('list', ['limit' => 200])->all();
        $this->set(compact('classificaco', 'feedback', 'usuariocomums'));
    }
